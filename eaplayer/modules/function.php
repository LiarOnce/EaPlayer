...
function eaplayer_scripts() {
    ...
    wp_enqueue_script('player-base', PLAYER_URL . '/assets/js/player-base.min.js', array(), PLAYER_VERSION , true);
    wp_enqueue_script('player', PLAYER_URL . '/assets/js/eaplayer.min.js', array(), PLAYER_VERSION , true);
}
